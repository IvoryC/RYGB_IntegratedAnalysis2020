...
pred.matrix <- read.table(paste0(output,ml.method,"/predictions_",ml.method,".tsv"), 
...
pdf(paste0(output,ml.method,'/performance_heatmap_', ml.method,'.pdf'), 
...
ggsave(g3, filename = paste0(output,ml.method,'/loso_performance_', 
                             ml.method,'.pdf'),
       width = 5.5, height = 3)
