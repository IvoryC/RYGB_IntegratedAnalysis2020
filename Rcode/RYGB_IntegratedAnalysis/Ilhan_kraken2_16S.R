...
input<-"./input/RYGB_Ilhan2020/Kraken2/"
...
for (t in taxa){
  ...
  myT<-read.table(paste0(input,"/RYGB_Ilhan_2020Apr23_taxaCount_norm_Log10_",t,".tsv"),
  ...
  if(t=="Species"){
    ...
    write.table(myT2,paste0(input,"Ilhan_speciesMetadata.txt"),sep="\t",quote = FALSE)
  }
